/* ============================================
   JavaScript Principal - MongoDB desde Cero
   ============================================ */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    codeBlocks.forEach(block => {
        ...
        const keywords = [
            ...
            'db', 'insertOne', 'insertMany', 'findOne', 'find',
            'updateOne', 'updateMany', 'deleteOne', 'deleteMany',
            'aggregate', 'group', 'match', 'sort', 'limit', 'skip',
            '$gte', '$lte', '$gt', '$lt', '$eq', '$ne', '$in', '$nin',
            '$and', '$or', '$not', '$nor', '$exists', '$type',
            '$push', '$pull', '$set', '$unset', '$inc', '$addToSet'
        ];
    ...
    console.log('%c🍃 MongoDB desde Cero', 'font-size: 20px; font-weight: bold; color: #47a248;');
    console.log('%c¡Bienvenido al curso de MongoDB!', 'font-size: 14px; color: #666;');
